...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC, {main="Queller rod",sub="Sors shield",ammo="Seraphic ampulla",
	head="Vanya hood",neck="Nodens gorget",ear2="Loquacious Earring",
        body="Vanya robe",hands="Vanya cuffs",ring1="Prolix Ring",
        back="Swith Cape ",waist="Witful belt",legs="Vanya slops",feet="Vanya clogs"})
